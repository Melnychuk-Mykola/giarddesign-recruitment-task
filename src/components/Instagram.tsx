...
export function Instagram() {
  ...
  return (
    <section
      id="instagram"
      ref={ref}
      aria-labelledby="instagram-tytul"
      className="scroll-mt-[72px] bg-cream py-14 lg:py-[60px]"
    >
      <div className="wrap-narrow">
        ...
        >
          <h2 id="instagram-tytul" className="max-w-[599px] font-display text-h3">
            ...
            Znajdziesz nas na <em className="heading-accent">Instagramie</em>.
          </h2>
          {/* 181px instead of the 157px in Figma: Inter needs the extra room to
              keep the line break where the mockup has it. */}
          <div className="flex flex-col items-start xl:w-[181px] xl:shrink-0">
